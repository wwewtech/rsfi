...
Qwen3-8B rows of Tables 1-2 ARE covered here: per-seed values are
loaded from data/results/E2q_qwen_multidataset.csv (concatenated with
the standard-embedder CSV in fixture `e2d` below) and verified against
the report. Generated by experiments/E2e_qwen_extension.py.
"""
