...
def run():
    ...
    for ds_name, (texts, labels) in datasets.items():
        if ds_name not in ("AdvBench", "HarmBench"):
            continue  # E14 focuses on the 4th-block behavior data
        lab = np.array(labels)
